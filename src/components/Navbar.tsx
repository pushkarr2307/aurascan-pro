import { ScanFace, LayoutDashboard, LogOut } from "lucide-react";
      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {user ? (
            ...
            <Link
              to="/login"
              className="glow-button px-5 py-2 rounded-lg bg-primary text-primary-foreground text-sm font-medium"
            >
              Admin Login
            </Link>
          )}
